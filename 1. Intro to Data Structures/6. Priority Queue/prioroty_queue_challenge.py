...
if __name__ == "__main__":
    ...
    print(result)
    # Your task is to add the items from `tasks` into a priority queue, and then to remove them into the solution list `ordered_task_list` so that `ordered_task_list` contains the items in the correct order.